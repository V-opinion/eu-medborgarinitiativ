(function() {
    ...
    document.querySelectorAll("img.avatar, img#bse-avatar").forEach(function(node) {
        node.onerror = function(){
            node.src = "http://publishme.se/static/img/default_avatar.png"
        }
    });
    ...
    var scriptFileName = '/static/js/comments.js';
